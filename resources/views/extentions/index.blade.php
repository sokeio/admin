        ...
        <div class="card-header p-1">
            <div class="w-100">
                <div class="row g-0 align-items-center">
                    <div class="col-auto px-4 fs-2 fw-bold pt-1">
                        {!! $page_title ?? '' !!}
                    </div>
                    <div class="col">
                        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button wire:click='switchManager()'
                                    class="nav-link @if ($viewType == 'manager') active @endif"
                            ...
                            <li class="nav-item" role="presentation">
                                <button wire:click='switchStore()'
                                    class="nav-link @if ($viewType == 'store') active @endif"
                            ...
                            <li class="nav-item" role="presentation">
                                <button wire:click='switchUpload()'
                                    class="nav-link @if ($viewType == 'upload') active @endif"
                                    data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">
